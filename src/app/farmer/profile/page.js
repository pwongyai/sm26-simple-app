...
export default function ProfileTab() {
  ...
  if (!me) return <p className="empty-msg">{t("Loading…")}</p>;

  return (
    <>
      <h1 className="my-3 text-base font-bold">{t("Profile")}</h1>
        ...
        {!editing ? (
          <>
            <div className="detail-row">
              <div className="lbl">{t("Your name")}</div>
              <div className="val">{me.name}</div>
            </div>
            <div className="detail-row">
              <div className="lbl">{t("Phone number")}</div>
          ...
          <>
            <div className="field-label">{t("Your name")}</div>
            <input
            ...
            />
            <p className="mt-1 text-[11px] text-[var(--text-tert)]">{t("This is how you sign in — changing it changes your login.")}</p>
      ...
      <p className="field-label">{t("Organization")}</p>
      <div className="detail-card mb-4">
        <div className="detail-row">
          <div className="lbl">{t("Community")}</div>
        ...
        <div className="detail-row">
          <div className="lbl">{t("Area unit")}</div>
          <div className="val">
            {me.areaUnit
              ? me.areaUnitM2
        ...
        <div className="detail-row">
          <div className="lbl">{t("Joined")}</div>
          <div className="val">
            {fmtDate(me.joinedAt)}
          </div>
        </div>
